    ...
    while (improved) {
        ...
        for (i in 0 until bestRoute.size) {
            for (j in i + 1 until bestRoute.size) {
                ...
                val candidateLength =
                    calculateRouteLengthAStar(userLocation, candidate, distanceCache)
...
fun MainScreen(
    ...
    val mapGrid = remember {
        val fileContent = try {
            ...
            Log.e("FILE_ERROR", "Файл не найден в assets, используем SAVED_GRID")
    ...
    Column(
        ...
        Controls(
            ...
            onUserRowChange = {
                ...
                manualUserCell =
                    if (r != null && c != null && r in 0 until ROWS && c in 0 until COLS) r to c else null
            },
            onUserColChange = {
            ...
            onRunFoodRoute = {
                ...
                if (userRow !in 0 until ROWS || userCol !in 0 until COLS) {
    ...
    Column(
        ...
        if (isDev) {
            card {
                ...
                mainButton("Выгрузить лог", onExportClick)
        ...
        card {
            ...
            if (clusteringMode) {
                ...
                mainButton("Запустить K-средних", onRunClustering)
            }
        }
        ...
        card {
            ...
            if (foodRouteMode) {
                ...
                mainButton("Построить", onRunFoodRoute)
                mainButton("Очистить", onClearFoodRoute)
        ...
        card {
            ...
            if (landmarkRouteMode) {
                ...
                mainButton("Построить", onRunLandmarkRoute)
                mainButton("Очистить", onClearLandmarkRoute)
        ...
        mainButton("Сменить режим", onChangeMode)
            ...
            Box(
                ...
                Box(
                    ...
                    Canvas(modifier = Modifier.fillMaxSize()) {
                        ...
                        landmarks.forEach { landmark ->
                            val color = if (landmark.id in selectedLandmarkIds) {
                                Color(0xFF9C27B0)
                            } else {
                                Color(0xFF00BCD4)
                            }
                        ...
                        if (clusteredPoints.isNotEmpty()) {
                            clusteredPoints.forEach { point ->
                                drawRect(
                                    color = clusterColors[point.clusterIndex % clusterColors.size].copy(
                                        alpha = 0.85f
                                    ),
                        ...
                        Text(
                            ...
                            modifier = Modifier
                                .offset(
                                    ...
                                    y = with(density) { (place.row * cellH - 28f).toDp() }
                                )
